...
<!-- Page Content  -->
    ...
    <button onclick="document.getElementById('myModal').style.display='block'" >Yeni ixtisas yaratmaq <i class="fa fa-plus"></i></button>
...
<div class="container1">
    ...
    <label for="ixtisas" value="ixtisas">İxtisas yarat:
        <input type="text" name="ixtisas" id="ixtisas"></label>
    ...
    <label for="say">Say limiti:
        <input type="number" name="say-az" id="say-az" value="say-az">
        <input type="number" name="say-rus" id="say-rus" value="say-rus">
        <input type="number" name="say-en" id="say-en" value="say-en">
    </label>
